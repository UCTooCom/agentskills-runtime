-- 智能投研助理落库 SQL
-- 生成时间: 2026-08-15T13:52:12.187808
...
INSERT INTO public.tasks (id, title, description, task_type, task_status, priority, company_id, tags, extra_data, created_at, updated_at) SELECT 'f3413eac-af6c-42d9-b796-1ea0bcea2ecc', '每日投资简报 - 贵州茅台', '# 每日投资简报 - 贵州茅台
...
INSERT INTO public.tasks (id, title, description, task_type, task_status, priority, company_id, tags, extra_data, created_at, updated_at) SELECT 'cf25cb33-a7ea-46c7-b0e5-0a1b986a3be9', '每日投资简报 - 五 粮 液', '# 每日投资简报 - 五 粮 液
...
INSERT INTO public.tasks (id, title, description, task_type, task_status, priority, company_id, tags, extra_data, created_at, updated_at) SELECT '08c191fd-4aab-41e2-b9c7-483f30f610c2', '每日投资简报 - 宁德时代', '# 每日投资简报 - 宁德时代
